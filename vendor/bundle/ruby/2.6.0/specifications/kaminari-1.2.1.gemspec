...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<kaminari-core>.freeze, ["= 1.2.1"])
    s.add_runtime_dependency(%q<kaminari-actionview>.freeze, ["= 1.2.1"])
    s.add_runtime_dependency(%q<kaminari-activerecord>.freeze, ["= 1.2.1"])
    ...
    s.add_dependency(%q<kaminari-core>.freeze, ["= 1.2.1"])
    s.add_dependency(%q<kaminari-actionview>.freeze, ["= 1.2.1"])
    s.add_dependency(%q<kaminari-activerecord>.freeze, ["= 1.2.1"])
